                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form method="post" id="role_form" action="<?=base_url()?>role/process" enctype="multipart/form-data" autocomplete="off">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input required name="RoleName" class="form-control" type="text" value="" id="example-text-input">
                                                </div>
                                                <div class="mb-3">
